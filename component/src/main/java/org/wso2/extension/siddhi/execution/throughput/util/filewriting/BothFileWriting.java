...
public class BothFileWriting implements Runnable {
    ...
    @Override public void run() {
      //  log.info("FILE WRITING" + "event count" + eventCount + "," + "currentTime" + currentTime + "value" + value
                       //  + "time" + timeSpent);
        try {
            ...
            fstream.write(
                    (eventCountTotal / recordWindow) + "," + ((eventCount * 1000) / value) + ","
                            ...
                            ((currentTime - firstTupleTime) / 1000f) + "," + eventCount + ","
                            + "" + eventCountTotal + "," + recordWindow + "," + firstTupleTime
                            + "," + value + "," + currentTime + "," + ((timeSpent * 1.0)
                            / eventCount) +
